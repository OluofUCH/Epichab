  ...
  return (
    <div className="bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 min-h-screen pt-[0rem]">
        ...
        <div className="relative z-10 text-center px-8">
          <h1 className="text-2xl md:text-7xl font-bold mb-6 tracking-wide">
      ...
      {/* Main Content */}
      <main className="max-w-full flex-center justify-center mx-auto px-0 sm:px-6 lg:px-8 py-0 sm:pb-[1.62rem]">
          ...
          <div className="max-w-full">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="group hover:scale-[1.01] transition-all duration-300">
                <div className="bg-white rounded-2xl p-2 shadow-xl border border-blue-100 relative overflow-hidden">
              ...
              <div className="group hover:scale-[1.01] transition-all duration-300">
                <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-2 shadow-xl text-white relative overflow-hidden">
